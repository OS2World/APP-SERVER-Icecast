...
#ifdef __OS2__
    /* [Digi] 2019-02-22 Sometimes function gethostbyname() starts to return 0
       for an existing name. Calling function endhostent() helps to fix the
       situation. However, I was not able to reproduce this problem in separate
       tests. Perhaps, this application corrupts the memory containing the
       DNS query results cache.
     */
    if ( host == NULL )
    {
      endhostent();
